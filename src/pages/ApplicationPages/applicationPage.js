...
const errorStyle = {
  ...
  function addProject() {
    ...
    const role = projRole.current.value
    const link = projLink.current.value
    if (name === '' || desc === '' || role === '') return
    setProjects(prevProject => {
      setProjectID(projectID + 1)
      return [...prevProject, {id: projectID, projectName: name, projectDesc: desc, role: role, link: link}]
    })
    projName.current.value = null
    projDesc.current.value = null;
    projRole.current.value = null
                      ...
                      <div style={entry}>
                       ...
                       ></TextField>
                        <Button
                               ...
                               borderRadius="20px"
                               variation="primary"
                               children="Add another university"
                               order="0"
                               fontSize="15px"
                               margin="0px 200px 0px 0px"
                               onClick={(e) => {e.preventDefault();addEducation()}}
                           ></Button>
                          </div>
                      </Flex>
                   </Flex>
                      ...
                      <div style={entry}>
                       ...
                       ></TextField>
                        <Button
                               ...
                               fontSize="15px"
                               margin="0px 200px 0px 0px"
                               onClick={(e) => {e.preventDefault();addProject()}}
                           ></Button>
                          </div>
                      </Flex>
                   </Flex>
